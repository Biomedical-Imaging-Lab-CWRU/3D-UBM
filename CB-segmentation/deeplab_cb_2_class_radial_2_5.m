...
for i= 1 : length(vol_names)
    ...
    imDir = ['C:\Users\axm1287\Desktop\lab_meeting_code_ciliary_body\data\cb_2_class_radial_2.5D\images'];
    pxDir = ['C:\Users\axm1287\Desktop\lab_meeting_code_ciliary_body\data\cb_2_class_radial_2.5D\gt'];
...
%     lgraph = connectLayers(lgraph,'softmax-out','labels');
    ...
    %
    tempdir = ['C:\Users\axm1287\Desktop\lab_meeting_code_ciliary_body\data\cb_2_class_radial_2.5D\results'];
    pxdsResults = semanticseg(pximds_va,Trained_Net,'MiniBatchSize',4,'WriteLocation',tempdir, 'NamePrefix', vol_names{i});
    
    
    save(['deeplab_cb_2_class_radial__2.5D_dice_' vol_names{i} '.mat'], 'Trained_Net', 'info');
    
    save(['validation_cb_2_class_radial_2.5D_dice_' vol_names{i} '.mat'], 'pximds_va');

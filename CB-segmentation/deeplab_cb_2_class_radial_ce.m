...
%     
    ...
    %
    tempdir = fullfile(['..\data\cb_2_class_radial\results_ce']);
    pxdsResults = semanticseg(pximds_va,Trained_Net,'MiniBatchSize',4,'WriteLocation',tempdir, 'NamePrefix', vol_names{i});
    
    
    save(['deeplab_cb_2_class_radial_ce_' vol_names{i} '.mat'], 'Trained_Net', 'info');
    
    save(['validation_cb_2_class_radial_ce_' vol_names{i} '.mat'], 'pximds_va');

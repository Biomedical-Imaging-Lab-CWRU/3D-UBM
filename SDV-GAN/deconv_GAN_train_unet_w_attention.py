# pix2pix with attention gate for UBM enhancement
...
def define_generator_with_attention(image_shape=(512, 512, 3)):
    # weight initialization
    init = RandomNormal(stddev=0.02)
...
def summarize_performance(step, g_model, val_dataset, n_samples=50):
	...
	# # save plot to file
	filename1 = './unet_with_attention/plot_%06d.png' % (step+1)
	# pyplot.savefig(filename1)
	# pyplot.close()
	# save the generator model
	filename2 = './unet_with_attention/model_%06d.h5' % (step+1)
...
# train pix2pix + attention models

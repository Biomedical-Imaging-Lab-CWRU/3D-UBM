# pix2pix with residual block for UBM enhancement
...
def define_generator_with_resblock(image_shape=(512,512,3)):
	# weight initialization
	init = RandomNormal(stddev=0.02)
	# image input
...
def summarize_performance(step, g_model, val_dataset, n_samples=50):
	...
	# # save plot to file
	filename1 = './unet_with_resblock/plot_%06d.png' % (step+1)
	# pyplot.savefig(filename1)
	# pyplot.close()
	# save the generator model
	filename2 = './unet_with_resblock/model_%06d.h5' % (step+1)
...
# train pix2pix+resblock models
def train(d_model, g_model, gan_model, dataset, val_dataset, n_epochs=30, n_batch=15):
...
g_model = define_generator_with_resblock(image_shape)
